---
title: "Using purrr::map with data frames"
description: |
  This post provides a walk through of applying purrr:map in the context of a data frame.  
author:
...
The following script can be used to import the data frames we will use for this example.
